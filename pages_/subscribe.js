...
function Subscribe() {
    ...
    for (let year in supportedYears) {
        yearItems.push(<li key={supportedYears[year]}><Link
            href={`year/${supportedYears[year]}`}><a>{supportedYears[year]}</a></Link></li>)
    }
        ...
        <>
            ...
            <Layout year='2020'>
                <section className={styles.subscribe}>
                    <Heading as="h3">{t('subscribe:title')}</Heading>
                    <div className="contentCard">
                        ...
                        <form
                            ...
                            <div className={styles.hidden}>
                                <input type="text" name="b_e11245c4d3fecdad90cb66908_f7a8a5001f" tabIndex="-1"
                                       defaultValue=""/>
                            </div>

                            <input type="submit" value={t('subscribe:button')} name="subscribe"
